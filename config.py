...
# =============================================================================
WAKE_WORD = "аля"
# Regex учитывает варианты распознавания Whisper:
# "Аля" → аля, ale, ali, алло (частая замена), аль
WAKE_WORD_PATTERN = r"(?:[аaАA][лlЛL][яеиeiЯЕИ]|[аaАA][лlЛL][лL][оoОо]|[аaАA][лlЛL][ьЬ])"
